...
POINT_LIST = [(50, 50), (1400, 90), (150, 300)]
...
def catch_screen():
    # im_opencv = get_screen.catch_screen("Hearthstone")
    im_opencv = get_screen.catch_screen()
    if im_opencv is None:
        print("未找到应用")
        sys.exit(-1)

    add_line(im_opencv, WINDOW_WIDTH_PX, WINDOW_HEIGHT_PX)
